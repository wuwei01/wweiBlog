...
public class FastDFSClientUtils {
    private static Logger log =LoggerFactory.getLogger(FastDFSClientUtils.class);
    ...
    public void setFastDFSClient(FastFileStorageClient fastFileStorageClient, FdfsWebServer fdfsWebServer) {
        FastDFSClientUtils.fastFileStorageClient = fastFileStorageClient;
        FastDFSClientUtils.fdfsWebServer = fdfsWebServer;
    }
