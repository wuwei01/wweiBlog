...
public class CommonDateUtils {
	 ...
	 * @return
	 */
	public static Date addDate(Date now, long addTime) {
		if (now == null) {
			return null;
		}
	...
	public static Date addDate(Date now, int year, int month, int day, int hour, int minute,
	...
	public static Date addDate(Date now, int hour, int minute, int second) {
